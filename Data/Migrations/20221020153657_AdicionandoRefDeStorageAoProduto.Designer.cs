...
namespace WebStock.Data.Migrations
{
    ...
    [Migration("20221020153657_AdicionandoRefDeStorageAoProduto")]
    partial class AdicionandoRefDeStorageAoProduto
    {
            ...
            modelBuilder.Entity("WebStock.Models.Storage", b =>
                {
                    b.HasOne("WebStock.Models.Product", "Product")
                        .WithOne("Storage")
                        .HasForeignKey("WebStock.Models.Storage", "ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
